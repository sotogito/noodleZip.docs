...
INSERT INTO tbl_badge_category (badge_group_id, badge_category_name, badge_description, is_active, badge_strategy)  
VALUES (2, 'ALL_COMMUNITY_POST_COUNT_BADGE', '전체 커뮤니티 글 작성 수', 1, 'LEVEL');  
INSERT INTO tbl_badge_category (badge_group_id, badge_category_name, badge_description, is_active, badge_strategy)  
VALUES (2, 'ALL_COMMENT_POST_COUNT_BADGE', '전체 댓글 작성 수', 1, 'LEVEL');  
INSERT INTO tbl_badge_category (badge_group_id, badge_category_name, badge_description, is_active, badge_strategy)  
VALUES (3, 'RAMEN_REVIEW_REGION_BADGE', '라멘 지역 리뷰', 1, 'LEVEL_ACCUMULATIVE');  
INSERT INTO tbl_badge_category (badge_group_id, badge_category_name, badge_description, is_active, badge_strategy)  
VALUES (4, 'RAMEN_REVIEW_CATEGORY_BADGE', '라멘 카테고리 리뷰', 1, 'LEVEL_ACCUMULATIVE');  
...
VALUES (1, 5, NULL, '골목 탐험가', 1, 5, 2, NOW(), NULL, 11, NULL),  
       ...
       (3, 5, NULL, '지역 지배지', 3, 15, 4, NOW(), NULL, 11, NULL),  
       ...
       (8, 5, NULL, '지역 지배지', 3, 15, 9, NOW(), NULL, 26, NULL),  
...
VALUES (6, NULL, '입문러', 1, 5, 87, NOW(), NULL, NULL, 1),  
       ...
       (6, NULL, '전설', 5, 50, NULL, NOW(), NULL, NULL, 5),INSERT INTO tbl_badge_group (badge_group_name)  
VALUES ('좋아요');  
INSERT INTO tbl_badge_group (badge_group_name)  
VALUES ('소통');  
INSERT INTO tbl_badge_group (badge_group_name)  
...
INSERT INTO tbl_badge_category (badge_group_id, badge_category_name, badge_description, is_active, badge_strategy)  
VALUES (1, 'REVIEW_GET_LIKE_COUNT_BADGE', '리뷰 좋아요 수 달성 배지', 1, 'LEVEL');  
INSERT INTO tbl_badge_category (badge_group_id, badge_category_name, badge_description, is_active, badge_strategy)  
VALUES (1, 'COMMUNITY_GET_LIKE_COUNT_BADGE', '커뮤니티 좋아요 수 달성 배지', 1, 'LEVEL');  
INSERT INTO tbl_badge_category (badge_group_id, badge_category_name, badge_description, is_active, badge_strategy)  
VALUES (2, 'ALL_COMMUNITY_POST_COUNT_BADGE', '전체 커뮤니티 글 작성 수 배지', 1, 'LEVEL');  
INSERT INTO tbl_badge_category (badge_group_id, badge_category_name, badge_description, is_active, badge_strategy)  
VALUES (2, 'ALL_COMMENT_POST_COUNT_BADGE', '전체 댓글 작성 수 배지', 1, 'LEVEL');  
INSERT INTO tbl_badge_category (badge_group_id, badge_category_name, badge_description, is_active, badge_strategy)  
VALUES (3, 'RAMEN_REVIEW_REGION_BADGE', '라멘 지역 리뷰 배지', 1, 'LEVEL_ACCUMULATIVE');  
INSERT INTO tbl_badge_category (badge_group_id, badge_category_name, badge_description, is_active, badge_strategy)  
VALUES (4, 'RAMEN_REVIEW_CATEGORY_BADGE', '라멘 카테고리 리뷰 배지', 1, 'LEVEL_ACCUMULATIVE');  
